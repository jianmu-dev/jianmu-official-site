    ...
    <div class="part-two-right">
      <div class="tab-btns">
        <div
          ...
          @click="tabClick(0)"
        >
          <img src="~@/assets/web/svgs/pip-bright.svg" v-if="tabIndex === 0" />
          <img src="~@/assets/web/svgs/pip-dark.svg" v-else />
          <span>管道</span>
        </div>
        <div
          ...
          @click="tabClick(1)"
        >
          <img v-if="tabIndex === 1" src="~@/assets/web/svgs/workflow-bright.svg" />
          <img src="~@/assets/web/svgs/workflow-dark.svg" v-else />
          <span>流程</span>
        </div>
      </div>
...
.part-two {
  height: 765px;
  margin-top: -50px;
  background-image: url('@/assets/web/svgs/pr-2-bg.svg');
