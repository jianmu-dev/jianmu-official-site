  ...
  <div class="contribute" ref="contributeWrapperRef">
    ...
    <div class="tabs">
      <div class="tabs-wrapper">
        <div :class="['tab-item',currentIndex===1 ? 'active':'']" @click="tabClick(1)">贡献者 . {{contributorCount}}</div>
         ...
         <div class="team-wrapper" v-if="teams?.length>0">
           <div class="team-part-card" v-for="(item,index) in teams" :key="index">
             ...
             <div class="team-member">
               <member-info-viewer customizeClass='team-item-viewer' v-for="(m,i) in item.contributors" :key="i" :name="m.username" :width="48" :img-url="m.avatarUrl"/>
             </div>
           </div>
         </div>
         <div class="empty" v-else>
