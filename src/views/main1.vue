...
<template>
  <div class="main">
    <div class="container">
      ...
      <div class="content-bg">
        <div class="content-wrapper">
          ...
          <div class="scrollar">
            <div class="scrollar-bar">
              <img src="~@/assets/pngs/scrollar-bar.png" />
            </div>
            <div class="scrollar-container">
              <div class="scrollar-content">
                <div class="pr-1">
    ...
    <div class="bottom-block">
      <div class="copy-info">
        ©2020-2021 版权所有 九州云信息科技有限 公司邮箱：<span
          ><a href="mailto:support@jianmu.dev">support@jianmu.dev</a></span
        >
      </div>
    </div>
  </div>
