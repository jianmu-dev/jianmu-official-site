...
// 轮播图图片
import swipperOne from '@/assets/wap/pngs/carousel-img-1.png';
import swipperTwo from '@/assets/wap/pngs/carousel-img-2.png';
import swipperThree from '@/assets/wap/pngs/carousel-img-3.png';
import swipperFour from '@/assets/wap/pngs/carousel-img-4.png';
    ...
    <div class="configure">
      ...
      <div class="controller-container">
        <div class="controller">
          <img
            src="@/assets/wap/svgs/left.svg"
            v-if="workFlowFlag"
          >
          <img
            src="@/assets/wap/svgs/left-active.svg"
            @click="toWorkFlow"
            v-else
          >
          <div
            ...
            v-if="workFlowFlag"
          >
            <img src="@/assets/wap/svgs/workflow-label.svg">
            流程
          </div>
          <div
            class="controller-title"
            v-else
          >
            <img src="@/assets/wap/svgs/flowchart.svg">
            管道
          </div>

          <img
            src="@/assets/wap/svgs/right.svg"
            v-if="pipeLineFlag"
          >
          <img
            src="@/assets/wap/svgs/right-active.svg"
            v-else
            @click="toPipeLine"
          >
        </div>
